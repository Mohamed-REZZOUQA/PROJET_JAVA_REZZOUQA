...
public class Playground {
    ...
    public Playground(String pathName) {
        try {
            ...
            final Image imageTrap = ImageIO.read(new File("./img/trap.png")); // Image du piège
                    ...
                    switch (element) {
                        ...
                        case 'W':
                            environment.add(new Trap(columnNumber * imageTrapWidth,
                                    lineNumber * imageTrapHeight, imageTrap, imageTrapWidth, imageTrapHeight, 10)); // 10 dégâts
                            break;
                    }
                    columnNumber++;
                }
